...
public class MainActivity extends AppCompatActivity {
    private BottomNavigationView btnMusikiKita;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initview();
        btnMusikiKita.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
    ...
    private void initview(){
        btnMusikiKita = findViewById(R.id.btn_musik_kita);
